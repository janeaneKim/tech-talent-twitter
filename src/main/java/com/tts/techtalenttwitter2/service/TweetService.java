package com.tts.techtalenttwitter2.service;
...
import com.tts.techtalenttwitter2.repository.TagRepository;
import com.tts.techtalenttwitter2.repository.TweetRepository;
...
public class TweetService {
	...
	private void handleTags(Tweet tweet) {
		List<Tag> tags = new ArrayList<Tag>(); //stores tags found
		...
		for(Tweet tweet: tweets) {
			...
			while(matcher.find()) {
				...
				if (link.length() > 23) {
					...
					String newLink = "<a class=\"tag\" href=\"" + link + "\" target=\" blank\">";
